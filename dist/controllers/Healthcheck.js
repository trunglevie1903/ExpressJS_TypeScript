...
var HealthcheckValidation_1 = __importDefault(require("@controllers/HealthcheckValidation"));
...
var HealthcheckController = /** @class */ (function () {
        ...
        this.get = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    ...
                    next(new HttpException_1.default(404, 'Healthcheck Failed!'));
                }
                return [2 /*return*/];
            });
        }); };
    ...
    HealthcheckController.prototype.initializeRoutes = function () {
        this.router.route(this.path)
            .get((0, ValidateRequest_1.default)(HealthcheckValidation_1.default.get), this.get);
    };
